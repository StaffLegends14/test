...
function setup() {
  ...
  rope = new Rope(14,{x:canW/2 + 490,y:30});
  ground = new Ground(canW/2,canH,canW,20);

  rope1 = new Rope(7,{x:canW/2 + 45,y:canH/2 - 600});
  rope2 = new Rope(7,{x:canW/2 + 10,y:0});
  rope3 = new Rope(7,{x:canW/2 + 100,y:200});

  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(canW - 100,canH - 80,100,100);
  bunny.scale = 0.2;
